...
func (q *Queries) CreateUser(ctx context.Context, arg CreateUserParams) (Users, error) {
	row := q.db.QueryRow(ctx, createUser, arg.Name, arg.Username, arg.PasswordHash)
	var i Users
	err := row.Scan(
		&i.ID,
		&i.Name,
...
SELECT id, name, username, password_hash, created_at FROM users
WHERE id = $1 LIMIT 1
`
...
func (q *Queries) UpdateUser(ctx context.Context, arg UpdateUserParams) (Users, error) {
	row := q.db.QueryRow(ctx, updateUser, arg.ID, arg.Name, arg.Username)
	var i Users
	err := row.Scan(
		&i.ID,
		&i.Name,
